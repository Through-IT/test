    ...
    <section class="portitem">
        <div class="row">
            <div class="col s12 m8 portiteminfo">
                <img src="/views/assets/images/portfolio/Resturaent.jpg" alt="Կայքի Նկար">
            </div>
            <div class="col s12 m4 portiteminfo">
                ...
                <p><strong>Կայք։</strong> <a href="http://restaurant.through-it.com/" target="_blank">restaurant.through-it.com</a></p>
            </div>
        </div>
    </section>
